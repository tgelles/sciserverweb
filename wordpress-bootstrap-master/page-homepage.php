...
<?php endif; ?>
	<footer class="text-center">
		<div id="footer2" style="-webkit-box-shadow: 0 -4px 0 rgba(180,180,184,.85);
...
<img src="/media/idies.logo_.small_.horizontal.black_.png" style="width: 300px; height:150px;" alt="logo">
	</div>
